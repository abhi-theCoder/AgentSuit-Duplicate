...
const FLODESK_BUYER_SEGMENT_ID_FOR_PROPOSAL = process.env.FLODESK_BUYER_SEGMENT_ID_FOR_PROPOSAL;
const FLODESK_SELLER_SEGMENT_ID_FOR_PROPOSAL = process.env.FLODESK_SELLER_SEGMENT_ID_FOR_PROPOSAL;
...
const initiateBuyerWorkflowForProposal = (email, firstName, lastName) => {
  return triggerFlodeskWorkflow(email, firstName, lastName, FLODESK_BUYER_SEGMENT_ID_FOR_PROPOSAL);
};

const initiateSellerWorkflowForProposal = (email, firstName, lastName) => {
  return triggerFlodeskWorkflow(email, firstName, lastName, FLODESK_SELLER_SEGMENT_ID_FOR_PROPOSAL);
};

module.exports = {
  initiateBuyerWorkflowForProposal,
  initiateSellerWorkflowForProposal,
};